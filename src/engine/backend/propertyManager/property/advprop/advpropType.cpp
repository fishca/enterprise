...
{
    m_precision = new wxUIntProperty(wxT("precision"), _("precision"), 0);
    AddPrivateChild(m_precision);
    m_scale = new wxUIntProperty(wxT("scale"), _("scale"), 0);
    AddPrivateChild(m_scale);
    m_date_time = new wxEnumProperty(wxT("date_time"), _("date time"), GetDateTime(), eDateFractions::eDateFractions_Date);
    AddPrivateChild(m_date_time);
    m_length = new wxUIntProperty(wxT("length"), _("length"), 0);
