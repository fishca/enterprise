...
CDesignerDocManager::CDesignerDocManager()
	: CMetaDocManager()
{
	AddDocTemplate(wxT("External data processor"), "*.edp", "", "edp", "Data processor Doc", "Data processor View", CLASSINFO(CDataProcessorFileDocument), CLASSINFO(CDataProcessorEditView), wxTEMPLATE_VISIBLE);
	AddDocTemplate(wxT("External report"), "*.erp", "", "erp", "Report Doc", "Report View", CLASSINFO(CReportFileDocument), CLASSINFO(CReportEditView), wxTEMPLATE_VISIBLE);
	AddDocTemplate(wxT("Configuration"), "*.mcf", "", "mcf", "Configuration Doc", "Configuration View", CLASSINFO(CMetadataFileDocument), CLASSINFO(CMetadataEditView), wxTEMPLATE_ONLY_OPEN);
	...
	AddDocTemplate(g_metaCommonTemplateCLSID, CLASSINFO(CSpreadsheetEditDocument), CLASSINFO(CSpreadsheetEditView));
