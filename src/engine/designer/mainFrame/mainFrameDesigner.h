...
enum {
	...
	wxID_DESIGNER_CONFIGURATION_EXPORT_XML,
	wxID_DESIGNER_CONFIGURATION_IMPORT_XML,

	wxID_DESIGNER_CONFIGURATION_EXPORT_JSON,
	wxID_DESIGNER_CONFIGURATION_IMPORT_JSON,
