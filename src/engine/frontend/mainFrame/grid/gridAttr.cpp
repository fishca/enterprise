...
void CGridExtCtrl::CGridExtDrawHelper::GetTextBoxSize(const wxDC& dc,
...
wxArrayString CGridExtCtrl::CGridExtDrawHelper::GetTextLines(wxDC& dc, const wxString& data, const wxFont& font, const wxRect& rect)
{
	wxArrayString lines;
...
void CGridExtCtrl::CGridExtDrawHelper::DrawTextRectangle(wxDC& dc,
	const wxArrayString& lines,
	const wxRect& rect,
	int horizAlign,
	int vertAlign,
...
class CGridExtRowHeaderRenderer :
	public wxGridExtRowHeaderRendererDefault {
public:
		...
		int textOrientation) const
	{
		...
		if (!grid.IsEnabled()) {
			...
			if (value.IsEmpty()) {
				CGridExtCtrl::CGridExtDrawHelper::DrawTextRectangle(dc, wxEmptyArrayString, rectShadow,
					horizAlign, vertAlign, textOrientation);
			}
			else {
				CGridExtCtrl::ParseLines(value, array);
				CGridExtCtrl::CGridExtDrawHelper::DrawTextRectangle(dc, array, rectShadow,
					horizAlign, vertAlign, textOrientation);
			}
		...
		// draw text 
		if (value.IsEmpty()) {
			CGridExtCtrl::CGridExtDrawHelper::DrawTextRectangle(dc, wxEmptyArrayString, rect, horizAlign, vertAlign, textOrientation);
		}
		else {
			CGridExtCtrl::ParseLines(value, array);
			CGridExtCtrl::CGridExtDrawHelper::DrawTextRectangle(dc,
				array, rect, horizAlign, vertAlign, textOrientation);
		}
	}
};

class CGridExtColumnHeaderRenderer :
	public wxGridExtColumnHeaderRendererDefault {
public:
...
class CGridExtCornerHeaderRenderer :
	public wxGridExtCornerHeaderRendererDefault {
public:
