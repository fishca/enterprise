...
protected:
    ...
    CPropertyColour* m_propertyFG = IPropertyObject::CreateProperty<CPropertyColour>(m_categoryWindow, wxT("fg"), _("fg"), _("Sets the foreground colour of the window."), wxDefaultStypeFGColour);
    CPropertyColour* m_propertyBG = IPropertyObject::CreateProperty<CPropertyColour>(m_categoryWindow, wxT("bg"), _("bg"), _("Sets the background colour of the window."), wxDefaultStypeBGColour);
