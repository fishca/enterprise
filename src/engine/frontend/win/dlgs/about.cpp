...
CDialogAbout::CDialogAbout(wxWindow* parent, int id) : wxDialog(parent, id, _("About..."))
{
	...
	m_staticText2 = new wxStaticText(this, wxID_ANY, wxString::Format(_("Open enterprise solutions, build %i"), GetBuildId()), wxDefaultPosition, wxDefaultSize, 0);
	...
	m_staticText6 = new wxStaticText(this, wxID_ANY, _("(C) 2026 Maxim 'nouverbe' Kornienko"), wxDefaultPosition, wxDefaultSize, 0);
	...
	m_staticText8 = new wxStaticText(m_panel1, wxID_ANY, _("Thanks:"), wxDefaultPosition, wxDefaultSize, 0);
	sizer3->Add(m_staticText8, 0, wxALL, 5);
	m_staticText9 = new wxStaticText(m_panel1, wxID_ANY, _("- wxWidgets team, wxFormBuilder team, 2C, Tomasz Sowa etc..."), wxDefaultPosition, wxDefaultSize, 0);
